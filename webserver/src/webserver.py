...
template_dir = verify_dir(Path(__file__).parent.parent / 'html', 'Template')
static_dir = verify_dir(Path(__file__).parent.parent / 'static', 'Static')
cert_dir = verify_dir(Path(__file__).parent.parent / 'cert', 'Cert')
...
def get_hosts():
    hosts_file_path = Path(f'{project_root}/event_scraper/.auth/.hosts.txt')
...
def update_hosts():
    ...
    hosts_file_path = f'{project_root}/event_scraper/.auth/.hosts.txt'
    if hosts:
